...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiResponse> handlingException(Exception exception) {
        ...
        // Include original exception message for better debugging
        String errorMessage = ErrorCode.UNCATEGORIZED_EXCEPTION.getMessage();
        if (exception.getMessage() != null && !exception.getMessage().isEmpty()) {
            errorMessage = errorMessage + " Chi tiết: " + exception.getMessage();
        }
    ...
    ResponseEntity<ApiResponse> handlingValidation(MethodArgumentNotValidException exception) {
        ...
        try {
            ...
            log.warn("ErrorCode not found for validation: {}", enumKey);
        }
